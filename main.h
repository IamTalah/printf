...
int print_string(va_list types, char buffer[],
	int flags, int width, int precision, int size);
int percent(va_list types, char buffer[],
	int flags, int width, int precision, int size);
...
int print_octal(va_list types, char buffer[],
	int flags, int width, int precision, int size);
int print hexadecimal(va_list types, char buffer[],
	int flags, int width, int precision, int size);
...
int print_rot13string(va_list types, char nuffer[],
	int flags, int width, int precision, int size);
...
int write_pointer(char buffer[], int ind, int length,
	int width, int flags, char pdd, char extra_c, int pdd_start);
